...
alias la='ls -A'
alias l='ls -CF'
alias apu='sudo apt update && sudo apt upgrade -y && sudo apt autoremove && sudo apt clean'
...
# OH MY POSH SETUPs
export PATH=$PATH:/home/setuc/.local/bin
...
_custom_env_completion() {
    ...
    # Add virtualenv environments (assuming they're in a standard location)
